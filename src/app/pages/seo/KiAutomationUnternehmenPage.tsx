    ...
    <>
      ...
      >
        ...
        {/* ============================================================
           ...
           marketing tagline.
        ============================================================ */}
        <section className="relative overflow-hidden bg-[var(--magicks-bg-elevated)] px-5 py-32 sm:px-8 sm:py-40 md:px-12 md:py-48 lg:px-16">
          <div
            aria-hidden
        ...
        ============================================================ */}
        <section className="relative overflow-hidden bg-[var(--magicks-bg-lifted)] px-5 py-28 sm:px-8 sm:py-36 md:px-12 md:py-44 lg:px-16">
          <div
            aria-hidden
                ...
                >
                  Zum Beispiel bei:
                        ...
                        <div className="mt-14 grid grid-cols-1 gap-0 border-t border-white/[0.08] sm:grid-cols-2 md:mt-20 md:grid-cols-2 lg:grid-cols-2">
                          ...
                          <article
                            data-ku-reveal
                            className="relative flex min-h-[13rem] flex-col justify-between border-b border-white/[0.08] bg-[var(--magicks-bg-lifted)] px-5 py-7 sm:min-h-[15rem] sm:px-6 sm:py-9 md:min-h-[17rem] md:px-9 md:py-12 lg:px-11"
                          >
        ...
        ============================================================ */}
        <section className="relative bg-[var(--magicks-bg-base)] px-5 py-32 sm:px-8 sm:py-40 md:px-12 md:py-48 lg:px-16">
          <div className="layout-max">
