        ...
        <section className="relative px-5 py-20 sm:px-8 sm:py-24 md:px-12 md:py-28 lg:px-16 lg:py-32">
          <div className="layout-max">
            ...
            <div data-wl-reveal className="mt-12 sm:mt-14 md:mt-16">
              <ContextualCrossLink
                eyebrow="Noch keine Website?"
                folio="Angebot · Website Starter"
                lead="Für Betriebe mit gutem Ruf, aber ohne eigene Website, gibt es den Website Starter als klaren ersten Schritt — einfacher Einstieg, professioneller Auftritt."
                linkLabel="Zum Website Starter"
                to="/website-starter"
              />
            </div>
          </div>
