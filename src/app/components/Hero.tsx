  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-5 pb-7 pt-[9rem] text-center sm:pt-[10rem] md:justify-start md:pb-10 md:pt-44 lg:pt-56">
        ...
        >
          <SectionEyebrow>MAGICKS · Digitale Marken &amp; Lösungen</SectionEyebrow>
        </motion.p>

        <motion.h1
          id="hero-heading"
          className="font-instrument max-w-[22rem] text-[1.85rem] font-normal leading-[1.12] tracking-[-0.03em] text-white sm:max-w-2xl sm:text-[2.35rem] md:max-w-3xl md:text-[2.9rem] lg:text-[3.25rem]"
        ...
        <motion.p
          className="font-ui mt-5 max-w-lg text-[15px] leading-[1.65] text-white/52 md:text-[0.9375rem]"
        ...
        <motion.p
          className="font-ui mt-3 max-w-sm text-[14px] font-medium leading-snug tracking-wide text-white/38"
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
