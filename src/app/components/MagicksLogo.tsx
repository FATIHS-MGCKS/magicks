type MagicksLogoProps = {
  ...
  className?: string;
  /** Farbmodus für Fälle ohne separates Asset. */
  tone?: "black" | "original";
};
 ...
 */
export function MagicksLogo({ className = "h-8", tone = "black" }: MagicksLogoProps) {
  ...
  const toneStyle =
    tone === "black" ? ({ filter: "brightness(0) saturate(100%)" } as const) : undefined;
