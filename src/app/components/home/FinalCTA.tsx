    ...
    >
      ...
      <div className="relative z-10 layout-max">
        <div className="mx-auto max-w-[68rem] rounded-[2rem] border border-[rgb(var(--magicks-line-rgb)/0.16)] bg-[linear-gradient(170deg,rgba(255,255,255,0.8)_0%,rgba(245,241,232,0.68)_100%)] px-6 py-12 text-center shadow-[0_32px_90px_-58px_rgba(20,28,44,0.3),inset_0_1px_0_rgba(255,255,255,0.84)] sm:px-10 sm:py-14 md:px-14 md:py-20">
          ...
          <span
            aria-hidden
            className="mx-auto mb-7 inline-flex items-center gap-3 rounded-full border border-[rgb(var(--magicks-accent-line-rgb)/0.22)] bg-[rgb(var(--magicks-accent-rgb)/0.07)] px-3 py-2 font-mono text-[10.5px] font-medium uppercase leading-none tracking-[0.18em] text-[rgb(var(--magicks-accent-ink-rgb)/0.78)] shadow-[inset_0_1px_0_rgba(255,255,255,0.62)] sm:mb-8 sm:text-[11px] sm:tracking-[0.22em]"
          >
            <span
              aria-hidden
